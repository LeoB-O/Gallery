  ...
  async componentDidMount() {
    ...
    this.constantPos = {
      ...
      horizontalRange: {
        ...
        rightSectionX: [
          3 * halfFigureWidth + halfStageWidth,
          stageWidth - halfFigureWidth,
        ],
      ...
      verticalRange: {
        ...
        topSectionY: [
          -halfFigureHeight,
          halfStageHeight - 3 * halfFigureHeight,
        ],
      },
    };
    ...
    this.setState({ ImgInfos });
    this.reArrangFigure(0);
  }
  render() {
    let navigators = [];
    let imgFigures = [];
    this.state.ImgInfos.forEach(
    ...
    return (
      <div className="stage" id="stage">
        ...
        <Button
          onClick={() => {
            this.setState({ addModalVsible: true });
          }}
          size="large"
          shape="circle"
          type="primary"
        ...
        <AddMedia
          visible={this.state.addModalVsible}
          onOk={() => {
            this.setState({ addModalVsible: false });
            setTimeout(() => {
              this.componentDidMount();
            }, 300);
          }}
